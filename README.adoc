...
`src/main/wrap_form_input_bug/client.cljs` contains the code to start and refresh
...
application `wrap_form_input_bug.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/wrap-form-input-bug.jar
```
